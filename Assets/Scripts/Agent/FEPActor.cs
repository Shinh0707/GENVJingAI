...
/// <summary>
/// Actor model for the FEP Agent.
/// Maps the state vector to a Beta distribution over actions.
/// </summary>
public class FEPActor : Module
{
    ...
    public FEPActor(int inputSize, int actionCount)
    {
